...
const Introduction = () => {
  return (
    <div className="relative h-screen animate-[slideTop_1s_ease-in-out]">
      <ImageRound
        src={'/images/introduce.jpg'}
        alt={'Image introduce part'}
        className="w-full h-full"
      />
      <div className="absolute top-1/2 transform -translate-y-1/2 flex flex-col gap-3 px-8 py-4 w-1/2">
